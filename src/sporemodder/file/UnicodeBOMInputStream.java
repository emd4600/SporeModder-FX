...
public class UnicodeBOMInputStream extends InputStream {
	...
	public static final class BOM {
		 ...
		 * NONE.
		 */
		public static final BOM NONE = new BOM(new byte[] {}, "NONE", "NONE");

		/**
		 * UTF-8 BOM (EF BB BF).
		 */
		public static final BOM UTF_8 = new BOM(new byte[] { (byte) 0xEF, (byte) 0xBB, (byte) 0xBF }, "UTF-8", "UTF-8");

		/**
		 * UTF-16, little-endian (FF FE).
		 */
		public static final BOM UTF_16_LE = new BOM(new byte[] { (byte) 0xFF, (byte) 0xFE }, "UTF-16 little-endian", "UTF-16LE");

		/**
		 * UTF-16, big-endian (FE FF).
		 */
		public static final BOM UTF_16_BE = new BOM(new byte[] { (byte) 0xFE, (byte) 0xFF }, "UTF-16 big-endian", "UTF-16BE");
		...
		public final Charset getCharset() {
			return Charset.availableCharsets().getOrDefault(charsetName, Charset.defaultCharset());
		}

		private BOM(final byte bom[], final String description, String charsetName) {
	 ...
	 *                              <code>InputStream</code> when trying to detect
	 *                              the Unicode BOM.
	 */
