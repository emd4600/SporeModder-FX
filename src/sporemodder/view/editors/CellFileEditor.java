...
import sporemodder.file.cell.CellFile;
import sporemodder.view.UserInterface;

public class CellFileEditor extends ArgScriptEditor<CellFile> {
	
	public CellFileEditor() {
		super();
	...
	@Override protected void showInspector(boolean show) {
		if (show) {
			UserInterface.get().getInspectorPane().configureDefault("Cell Stage Cell File (CELL)", "CELL", null);
		} else {
