...
import sporemodder.file.cell.CellGlobalsFile;
import sporemodder.view.UserInterface;

public class CellGlobalsEditor extends ArgScriptEditor<CellGlobalsFile> {
	
	public CellGlobalsEditor() {
		super();
	...
	@Override protected void showInspector(boolean show) {
		if (show) {
			UserInterface.get().getInspectorPane().configureDefault("Cell Stage Globals (GLOBALS)", "GLOBALS", null);
		} else {
