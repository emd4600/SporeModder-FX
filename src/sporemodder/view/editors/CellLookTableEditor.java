...
import sporemodder.file.cell.CellLookTableFile;
import sporemodder.view.UserInterface;

public class CellLookTableEditor extends ArgScriptEditor<CellLookTableFile> {
	
	public CellLookTableEditor() {
		super();
	...
	@Override protected void showInspector(boolean show) {
		if (show) {
			UserInterface.get().getInspectorPane().configureDefault("Cell Stage Look Table (LOOK_TABLE)", "LOOK_TABLE", null);
		} else {
