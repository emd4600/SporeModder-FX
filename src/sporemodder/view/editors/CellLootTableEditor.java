...
import sporemodder.file.cell.CellLootTableFile;
import sporemodder.view.UserInterface;

public class CellLootTableEditor extends ArgScriptEditor<CellLootTableFile> {
	
	public CellLootTableEditor() {
		super();
	...
	@Override protected void showInspector(boolean show) {
		if (show) {
			UserInterface.get().getInspectorPane().configureDefault("Cell Stage Loot Table (LOOTTABLE)", "LOOTTABLE", null);
		} else {
