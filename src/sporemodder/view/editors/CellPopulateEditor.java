...
import sporemodder.file.cell.CellPopulateFile;
import sporemodder.view.UserInterface;

public class CellPopulateEditor extends ArgScriptEditor<CellPopulateFile> {
	
	public CellPopulateEditor() {
		super();
	...
	@Override protected void showInspector(boolean show) {
		if (show) {
			UserInterface.get().getInspectorPane().configureDefault("Cell Stage Popualte File (POPULATE)", "POPULATE", null);
		} else {
