...
import sporemodder.file.cell.CellPowersFile;
import sporemodder.view.UserInterface;

public class CellPowersEditor extends ArgScriptEditor<CellPowersFile> {
	
	public CellPowersEditor() {
		super();
	...
	@Override protected void showInspector(boolean show) {
		if (show) {
			UserInterface.get().getInspectorPane().configureDefault("Cell Stage Powers (POWERS)", "POWERS", null);
		} else {
