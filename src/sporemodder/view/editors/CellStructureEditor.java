...
import sporemodder.file.cell.CellStructureFile;
import sporemodder.view.UserInterface;

public class CellStructureEditor extends ArgScriptEditor<CellStructureFile> {
	
	public CellStructureEditor() {
		super();
	...
	@Override protected void showInspector(boolean show) {
		if (show) {
			UserInterface.get().getInspectorPane().configureDefault("Cell Stage Structure (STRUCTURE)", "STRUCTURE", null);
		} else {
