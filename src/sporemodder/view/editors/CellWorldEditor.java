...
import sporemodder.file.cell.CellWorldFile;
import sporemodder.view.UserInterface;

public class CellWorldEditor extends ArgScriptEditor<CellWorldFile> {
	
	public CellWorldEditor() {
		super();
	...
	@Override protected void showInspector(boolean show) {
		if (show) {
			UserInterface.get().getInspectorPane().configureDefault("Cell Stage World (WORLD)", "WORLD", null);
		} else {
